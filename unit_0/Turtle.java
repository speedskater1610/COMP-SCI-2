// I did modify the turtle so it would work for L02P03 and no longer use a old api
 ...
 */
    ...
    /**
     * I RUSSEL EINSLA WROTE THIS SO THAT THE PENCOLOR EMTHOD CAN TAKE HEX VALUES FOR MY L02P03
     * 
     * 
    ...
    public long penColor(String penColor) {
        ...
        // check for hex format (#RRGGBB | #RGB)
            if (penColor != null && penColor.startsWith("#")) {
            try {
                c = Color.decode(penColor);  // parses hex like #ff00aa
            } catch (NumberFormatException e) {
                // fall back to named color if not valid hex
            }
        }

        // if not a valid hex -> fall back to named color map like before
        if (c == null) {
            c = Turtle.getColor(penColor);
        }
