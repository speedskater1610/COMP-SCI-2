...
Problem 3 - Draw a line from (0,0) to (50, 73).  The line should be blue.
  
Problem 4 - Draw a T.  The lines of the T should be 20px wide and should be purple.
...
Problem 3 - Draw a dashed line from (-200, 200) to (100, -200).  Each dash (and break) should be 50 pixels long, 10 px wide and each dash should be a different color. (you will need turtle.face(x, y))
