...
public class Level3 {
    public static void main(String[] args) {
        ...
        printPasswordStatus(password);
    }

    public static void printPasswordStatus(String password) {
        boolean password_bad = false;
        ...
        if (!password.contains("1")) {
            System.out.println(password + " doesnt contain '1'");
            password_bad = true;
        }
        
        if (password.charAt(0) != 'P') {
            System.out.println(password + " doesnt start with 'P'");
            password_bad = true;
        }
        
        if (password_bad) { return; }
