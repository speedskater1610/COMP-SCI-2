...
- `gcc` The Gnu Compiler Collection - allows for compilation of C / C++ / Fortran and many more programming languages
...
1. Lexical Analysis - lexing - Taking in the raw source ("Words") and turning them into a set of tokens that we can more easily track
...
[*read next* Lexing](https://www.github.com/speedskater/COMP-SCI-2/tree/main/NOTES_EXTRA/lexical_analysis.md)